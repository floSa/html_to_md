...
**76 tests** couvrent les deux pipelines, la CLI et l'interface. Les documents Word et PowerPoint sont fabriqués à la volée plutôt que versionnés. Détail par fichier : [docs/ARCHITECTURE.md §10](docs/ARCHITECTURE.md#10-tests).
